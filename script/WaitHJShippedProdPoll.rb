...
#
# Given a list of orders, waiting days on the Oracle HJ shipment tables to be populated
#
...
exit QACommandLine.process { |o| ValidateOracleShipments.db_t_al_host_longpoll(o) }
